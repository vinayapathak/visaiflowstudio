...
defineProps<{
  name: 'moon' | 'log' | 'shuffle' | 'reset' | 'chevron-left' | 'chevron-right';
}>();
</script>
...
<template>
  ...
  <svg v-else-if="name === 'chevron-left'" width="16" height="16" viewBox="0 0 24 24">
    <path
      fill="currentColor"
  ...
  <svg v-else-if="name === 'chevron-right'" width="16" height="16" viewBox="0 0 24 24">
    <path
      fill="currentColor"
